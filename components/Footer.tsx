  ...
  return (
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.copyright}>Copyright 2022 {config.author}. 
        ...
        support. 
        <a  href="#"><img className={styles.hits} src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fwww.liu.he.cn&count_bg=%23CDCDCD&title_bg=%23003366&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false"/></a>
      </div>
